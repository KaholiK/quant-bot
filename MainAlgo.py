...
from algos.core.config_loader import get_legacy_dict, load_config
...
from algos.core.portfolio import HRPOptimizer, Portfolio
...
class MainAlgo(QCAlgorithm):
    ...
    def _get_ml_prediction(self, features: pd.Series) -> float | None:
