...
async def make_api_request(endpoint: str, method: str = "GET", data: Optional[Dict] = None) -> Optional[Dict]:
...
async def kill_switch(interaction: discord.Interaction, reason: Optional[str] = "Manual Discord kill switch"):
...
async def export_trades(interaction: discord.Interaction, symbol: Optional[str] = None, days: int = 30):
