...
class Settings(BaseSettings):
    ...
    DISCORD_GUILD_ID: int | None = Field(default=None, description="Discord guild (server) ID")
    DISCORD_REPORTS_CHANNEL_ID: int | None = Field(default=None, description="Channel for automated reports")
    DISCORD_WEBHOOK_URL: str | None = Field(default=None, description="Webhook for notifications")
    DISCORD_APP_ID: int | None = Field(default=None, description="Discord application ID")
    ...
    QUANDL_API_KEY: str | None = Field(default=None, description="Quandl API key")

    # Crypto data providers
    COINGECKO_API_KEY: str | None = Field(default=None, description="CoinGecko API key")
    CRYPTOCOMPARE_API_KEY: str | None = Field(default=None, description="CryptoCompare API key")

    # Optional power-ups
    OPENAI_API_KEY: str | None = Field(default=None, description="OpenAI API key for narration")
    WANDB_API_KEY: str | None = Field(default=None, description="Weights & Biases API key")
    DATABASE_URL: str | None = Field(default=None, description="PostgreSQL connection URL (optional)")
    ...
    def preferred_equity_provider(self) -> str | None:
        """
    ...
    def preferred_crypto_provider(self) -> str | None:
        """
